    ...
    switch (event.subtype) {
      ...
      case 'message_changed': {
        ...
        if (event.message.thread_ts) {
          ...
          if (modified.replyCount !== original.replyCount) {
            original.replyCount = modified.replyCount
            original.replyUsers = modified.replyUsers
            modified = original
          }
          const thread = channel.findThread(event.message.thread_ts)
          if (thread)
      ...
      case 'message_replied': {
        ...
        // Emit event in thread and channel.
