...
class ChannelsPanel {
  ...
  loadAccount(account) {
    ...
    this.subscription = {
      ...
      onAddChannel: account.onAddChannel.add(this.onAddChannel.bind(this)),
      onRemoveChannel: account.onRemoveChannel.add(this.onRemoveChannel.bind(this)),
    }
