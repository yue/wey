...
class ChannelItem {
  constructor(parent, channel) {
    ...
    this.subscription = {
      onMessage: channel.onMessage.add(this.update.bind(this)),
      onMarkRead: channel.onMarkRead.add(this.update.bind(this)),
    }
  ...
  unload() {
    ...
    this.subscription.onMarkRead.detach()
  }

  select() {
    this.isSelected = this.channel.isSelected = true
    this.channel.markRead()
    this.view.schedulePaint()
  }

  deselect() {
    this.isSelected = this.channel.isSelected = false
    this.view.schedulePaint()
  }
