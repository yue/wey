...
class NotificationCenter {
  constructor() {
    ...
    if (process.platform !== 'darwin') {
      this.trayIcon = gui.Image.createFromPath(path.join(__dirname, 'tray', 'icon.png'))
      this.attentionIcon = gui.Image.createFromPath(path.join(__dirname, 'tray', 'attention.png'))
